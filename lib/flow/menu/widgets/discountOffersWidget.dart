...
import 'package:customer_app/flow/menu/controllers/categoriesProductsApiController.dart';
import 'package:customer_app/main.dart';
import 'package:customer_app/utils/navigatorService.dart';
import 'package:customer_app/utils/snackBars.dart';
                  ...
                  offersController.tempChangeOffer.value
                      ? InkWell(
                          ...
                          child: AnimatedContainer(
                            ...
                            height:
                                widget.isVisible! ? widget.height! * 0.13 : 0,
                      ...
                      : InkWell(
                          ...
                          child: AnimatedContainer(
                            height:
                                widget.isVisible! ? widget.height! * 0.13 : 0.0,
                            width: widget.width! * 0.95,
                            decoration: BoxDecoration(
                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl:
                                        offersController.offersList[0].image!,
                                    fit: BoxFit.fitWidth,
                                    height: widget.height,
                                    width: widget.width,
